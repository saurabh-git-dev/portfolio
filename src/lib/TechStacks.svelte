	...
	>
		...
		>
			<p class="text-justify text-xs">
				Discovered
				<img src="/images/go.svg" alt="GoLang Logo" class="mb-1 inline w-8" /> a bit late, but absolutely
				...
				OS native binaries, which is one of the advantages over Python and javascript. Probably Zig is
				going to be my first choice for low level programming in future.
			</p>
		</div>
	</div>
</div>
