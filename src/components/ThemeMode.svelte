...
<div class="relative">
	...
	>
		<svg
			...
			viewBox="0 0 20 20"
			fill="currentColor"
			class="group:hover:text-neutral-100 absolute h-6 w-6 sm:h-7 sm:w-7 opacity-0 dark:opacity-100"
		>
		...
		<svg
			...
			viewBox="0 0 20 20"
			fill="currentColor"
			class="group:hover:text-neutral-100 absolute h-6 w-6 sm:h-7 sm:w-7 opacity-100 dark:opacity-0"
		>
			<path
				fill-rule="evenodd"
